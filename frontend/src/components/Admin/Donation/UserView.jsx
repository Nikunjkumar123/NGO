          ...
          <div className="modal-content">
            ...
            <div className="modal-body mt-4">
              <div className="row mb-3">
                ...
                <div className="col-6">
                  <p className="mb-1">
                    <strong>Eligible for Team Royalty Remuneration?</strong>
                  </p>

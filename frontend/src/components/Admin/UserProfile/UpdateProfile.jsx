  ...
  const handleInfoSubmit = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        Swal.fire(
          "Failed",
          "Failed to update nominee details. Please try again.",
          "error"
        );
      }
    } catch (error) {
      ...
      Swal.fire(
        "Error",
        "An error occurred while updating nominee details.",
        "error"
      );
    }
  };
    ...
    try {
      ...
      if (isValidPAN) {
        ...
        if (res.status === 200) {
          Swal.fire(
            "Success",
            "Pan Number details updated successfully!",
            "success"
          );
        } else {
          Swal.fire(
            "Failed",
            "Failed to update Pan Number details. Please try again.",
            "error"
          );
        }
      } else {
      ...
      Swal.fire(
        "Error",
        "An error occurred while updating Pan Number details.",
        "error"
      );
    }
  };
  ...
  const handleSubmitGST = async (e) => {
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        Swal.fire(
          "Failed",
          "Failed to update GST Number. Please try again.",
          "error"
        );
      }
    } catch (error) {
      ...
      Swal.fire(
        "Error",
        "An error occurred while updating GST Number.",
        "error"
      );
    }
  };
            ...
            <div className="card mt-4">
              ...
              <div className="card-body">
                <form onSubmit={handleInfoSubmit}>
                  ...
                  <div className="row mb-3">
                    <div className="col-md-6">
                      <label htmlFor="nomineeNumber" className="form-label">
                    ...
                    <div className="col-md-6">
                      <label htmlFor="nomineeAddress" className="form-label">
                        Nominee Address
                      </label>
                      <textarea
                        className="form-control"

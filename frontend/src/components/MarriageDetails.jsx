      ...
      <div className="container pb-5">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="mb-4 donating">
              ...
              <h3 className="fs-5 fw-bolder">
                Support for Underprivileged Marriage Ceremonies
              </h3>
              <p>
                Your contribution plays a vital role in bringing happiness and
                hope to couples from underprivileged backgrounds. Many deserving
                couples dream of celebrating their special day with dignity and
                joy but lack the financial means to make it a reality. With your
                generous support, we can provide them with essential resources
                for a beautiful and memorable wedding ceremony, ensuring they
                embark on their new journey with love, respect, and a sense of
                belonging. Together, we can make their dream day truly special.
              </p>
              <p>#8976</p>
        ...
        <div className="row">
          <div className="donation-box">
            <h2>Support Us</h2>
            <p>
              Celebrating the union of two hearts! Wishing the newlyweds a
              lifetime of love, joy, and happiness together.
            </p>

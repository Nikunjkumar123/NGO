      ...
      <div className="container pb-5">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="mb-4">
              <img
                ...
                alt="Accidental Support and Recovery Fund"
              />
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-12">
            <div className="mb-4 donating">
              ...
              <h3 className="fs-5 fw-bolder">
                Accidental Support and Recovery Fund
              </h3>
              <p>
                Your contributions provide essential and life-changing support
                to individuals and families impacted by accidents. These
                unforeseen incidents often bring immense emotional and financial
                stress, leaving victims and their loved ones struggling to cope.
                Every donation you make helps cover critical needs, including
                emergency medical treatments, hospital expenses, rehabilitation
                therapies, and other essential resources required for a full
                recovery. Together, we can extend a helping hand to those in
                dire need, offering them a chance to rebuild their lives with
                hope, dignity, and renewed strength. Your kindness not only
                ensures better outcomes for accident survivors but also serves
                as a powerful reminder that no one faces such challenges alone.
              </p>
        ...
        <div className="row">
          <div className="donation-box">
            <h2>Support Us</h2>
            <p>
              Thank you for considering supporting us. Your contribution helps
              us continue our work and make a difference. Please select a
              donation amount or enter your own custom amount below.
            </p>
